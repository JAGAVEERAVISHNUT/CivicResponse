...
export default async function AdminIssueDetailPage({ params }: IssueDetailPageProps) {
  ...
  const { data: l1Officers } = await supabase
    .from("profiles")
    .select("*")
    .eq("role", "l1_officer")
    .order("full_name");

  const { data: l2Officers } = await supabase
    .from("profiles")
    .select("*")
    .eq("role", "l2_officer")
    .order("full_name");
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Activity Log */}
            <ActivityLogView issueId={issueWithProfiles.id} />
          ...
          <div className="space-y-6">
            ...
            <AdminIssueActions 
              ...
              l1Officers={l1Officers || []}
              l2Officers={l2Officers || []}
            />
