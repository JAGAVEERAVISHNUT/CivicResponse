...
import { L1IssueActions } from "@/components/l1-issue-actions";
...
export default async function L1IssueDetailPage({ params }: IssueDetailPageProps) {
  ...
  if (!profile || profile.role !== 'l1_officer') {
    redirect("/auth/login");
  }
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        <Button variant="ghost" asChild className="mb-4">
          <Link href="/l1-dashboard">← Back to Dashboard</Link>
        </Button>
